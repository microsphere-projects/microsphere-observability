...
public abstract class SystemUtils {
     ...
     */
    @Nonnull
    public static String getCGroupDirectoryPath() {
        return getProperty(CGROUP_DIRECTORY_PATH_PROPERTY_NAME, DEFAULT_CGROUP_DIRECTORY_PATH_PROPERTY_VALUE);
    }

    /**
     * Get the Network Stats File Path
     *
     * @return the Network Stats File Path
     */
    @Nonnull
    public static String getNetworkStatsFilePath() {
        return getProperty(NETWORK_STATS_FILE_PATH_PROPERTY_NAME, DEFAULT_NETWORK_STATS_FILE_PATH);
    }

    /**
     * Get the Metrics Collection Interval(unit : millisecond)
     *
     * @return the Metrics Collection Interval(unit : millisecond)
     */
