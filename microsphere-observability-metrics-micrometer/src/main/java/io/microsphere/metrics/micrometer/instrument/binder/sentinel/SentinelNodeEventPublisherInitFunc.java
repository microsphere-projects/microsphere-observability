...
/**
 * {@link InitFunc} for {@link SentinelNodeEventPublisher}
 *
 * @author <a href="mailto:mercyblitz@gmail.com">Mercy</a>
 * @see SentinelNodeEventPublisher
 * @since 1.0.0
 */
public class SentinelNodeEventPublisherInitFunc implements InitFunc {

    @Override
    public void init() {
        SentinelNodeEventPublisher sentinelNodeEventPublisher = new SentinelNodeEventPublisher();
        addEntryCallback(sentinelNodeEventPublisher);
    }
}