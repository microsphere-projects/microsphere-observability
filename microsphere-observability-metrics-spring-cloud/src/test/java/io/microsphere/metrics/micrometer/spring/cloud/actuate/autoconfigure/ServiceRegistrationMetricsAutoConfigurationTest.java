...
import io.microsphere.spring.cloud.client.service.registry.autoconfigure.SimpleAutoServiceRegistrationAutoConfiguration;
...
/**
 * {@link ServiceRegistrationMetricsAutoConfiguration} Test
 *
...
@SpringBootTest(
        classes = {
                ...
                ServiceRegistrationMetricsAutoConfiguration.class,
                SimpleAutoServiceRegistrationAutoConfiguration.class,
                ServiceRegistrationMetricsAutoConfigurationTest.class
        },
        webEnvironment = NONE,
        properties = {
                "server.port=8080",
...
class ServiceRegistrationMetricsAutoConfigurationTest extends AutoConfigurationTest<ServiceRegistrationMetricsAutoConfiguration> {

    @Override
    protected void configureAutoConfiguredClasses(Set<Class<?>> autoConfiguredClasses) {
        autoConfiguredClasses.add(MeterRegistryCustomizer.class);
    }
