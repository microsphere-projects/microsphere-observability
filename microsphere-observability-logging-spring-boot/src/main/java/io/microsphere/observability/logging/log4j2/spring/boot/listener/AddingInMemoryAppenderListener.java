...
import static io.microsphere.logging.log4j2.util.Log4j2Utils.addAppenderForAllLoggers;
 ...
 * @since 1.0.0
 */
public class AddingInMemoryAppenderListener implements ApplicationListener<ApplicationStartingEvent> {
    ...
    private void initializeInMemoryAppender() {
        ...
        addAppenderForAllLoggers(inMemoryAppender);
    }
}