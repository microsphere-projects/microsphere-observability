...
import io.microsphere.observability.logging.log4j2.spring.boot.listener.AddingInMemoryAppenderListener;
...
public class Log4j2AutoConfiguration {
    ...
    class KafkaAppenderConfiguration implements ApplicationListener<ApplicationStartedEvent> {
        ...
        private KafkaAppender buildKafkaAppender(ConfigurableApplicationContext context) {
