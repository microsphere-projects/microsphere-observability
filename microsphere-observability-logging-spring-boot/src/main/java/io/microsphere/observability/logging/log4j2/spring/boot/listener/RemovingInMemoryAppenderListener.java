 ...
 */
package io.microsphere.observability.logging.log4j2.spring.boot.listener;
...
import static io.microsphere.logging.log4j2.util.Log4j2Utils.removeAppenderForAllLoggers;
 ...
 * @since 1.0.0
 */
public class RemovingInMemoryAppenderListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    private void removeInMemoryAppender() {
        ...
        removeAppenderForAllLoggers(inMemoryAppender);
    }
}