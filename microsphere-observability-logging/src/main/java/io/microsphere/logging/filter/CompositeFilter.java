...
import static io.microsphere.logging.filter.CompositeFilter.Operator.OR;
import static io.microsphere.logging.filter.Filter.Result.NEUTRAL;
...
public class CompositeFilter implements Filter {
    ...
    private Operator operator = OR; // Default "OR"
